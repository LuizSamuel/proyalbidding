					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								$books = $conn->query("SELECT py.*, b.*, u.name as uname,p.name,p.bid_end_datetime bdt FROM payments py inner join bids b on b.id = py.bid_id inner join users u on u.id = b.user_id inner join products p on p.id = b.product_id ");
